...
class BaseFieldTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function testdump()
  {
    ...
    $this->assertEquals('field_name: text, DEFAULT=\'some text\'',
      $field->dump());
    ...
    $field->unique = true;
    $this->assertEquals('field_name: integer(5), UNIQUE, PRIMARY',
      $field->dump());

    $field->autoIncrement = true;
    $this->assertEquals('field_name: integer(5), UNIQUE, PRIMARY, AUTOINC',
      $field->dump());
  }
